...
<Stack sx={{
      ...
      <Typography sx={{
        ...
        This course was all about how we can get good data, while the machine learning course, which I will soon get to, was all about the techniques
        themselves.
      ...
      <Typography sx={{
        ...
        local machine. We learned plenty of different kinds of exploits during this course. Such as when we performed a buffer overflow 
        attack, though we had to disable modern built in protections to get it to work properly. We had to manually find the correct size to get 
        the buffer overflow to work properly, though the exploit code was provided to use. I love these kinds of practical learning, theoretical 
        can only get you so far until you need to do the work yourself. Its why I make practice projects, they help me learn the content far better than 
        ...
        possible, as they had around 20 employees and over 100 students working for them, which to put it mildly, is just not how 
        companies work.
        <br></br><br></br>
        Web Application Development was the course that was the most immediately practical to my first job. As even with increasingly large amounts
        of web dev done by AI Web Development is one of the largest field of computer science. This was where I learned how to create REST based systems, 
        though this was lightly covered in Network Cybersecurity, as web interfaces are part of a network. The Project for this course was a web based version
        of the Card Game Coup. The game was hosted on github pages, just like this website as of time of writing, were up to eight players could join a lobby 
        and play the card game. My work on this group project was just on the backend work for the login, as this was a large group project of five people so we 
        each had work to focus on.
        <br></br><br></br>
        Introduction to Artificial Intelligence was my first full course about learning machine learning (though I had working with Tensorflow a little all 
        the way back in high school). This course had a lot in common with my data science course, many of the same techniques were the same as the ones from 
        Datamining, but the focus was the mechanics of the techniques. We had a lot of fun mini projects, such as building a model to predict if a mushroom was toxic
        based off of its known features such as the shape of the cone. The major project was one were we could use any open source database to search for any data 
        of our choice. We choose to analyses stock market data over to get some results. Of course the data was rough, but if we could predict the stock market I wouldn't
        be here, would I?
        <br></br><br></br>
        My capstone project was more data analytics. The project was an analysis of infrastructure and public health, such as cycling. We took density information of different
        kinds of infrastructure such as how many highways, streets, bike paths, etc were in a 5km, 15km, or 30km radius. We used different models and techniques in R to discover information
        from the raw data. The Primary method that we used the most for our data was forward and backward AIC and BIC, which stand for Akaike Information Criterion and 
        the Bayesian Information Criterion. We also used decision trees to find relevant information. The initial hope for our prof was that we could find something interesting 
        to publish but in the end while we did find some relevant information, it was not enough to make a full paper out of.
      </Typography>
      </BlogEntryAllText>
